      ...
      <div>
                ...
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white pt-5 pb-4">
                  ...
                  >
                    <img
                      ...
                      alt="ChatFlow"
                    />
                    <span className="ml-1 text-xl font-bold">ChatFlow</span>
        ...
        <div className="flex flex-col min-h-screen">
          <div className="sticky top-0 z-[9999] flex h-14  bg-white border-b border-gray-200 ">
            <button
              type="button"
              className="border-r border-gray-200 px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black md:hidden"
